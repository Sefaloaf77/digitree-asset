...
window.dataTable = function () {
  return {
    ...
    initData() {
      ...
      fetch("/get-plants") // Replace with your actual data URL
        .then((response) => response.json())
        .then((data) => {
          this.items = data.sort(
            this.compareOnKey("index_plant_data.name", "asc")
          ); // Assuming 'data' is the key in the response
