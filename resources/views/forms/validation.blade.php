    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <form class="space-y-4">
                <div>
                    <input id="firstName1" type="text" placeholder="First Name" class="form-input !text-danger !border-danger" value="William Robbie" required="">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <form class="space-y-4">
                <div>
                    <input id="firstName2" type="text" placeholder="First Name" class="form-input !text-success !border-success" value="William Robbie" required="">
