    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <form class="space-y-4">
                <label class="flex">
                    <div class="flex items-center border-r-0 justify-center rounded-l border-2 border-gray/10 bg-gray/[8%] px-3.5">
                        <span>@</span>
                    </div>
                ...
                <label class="flex">
                    ...
                    <div class="flex items-center justify-center rounded-r border-l-0 border-2 border-gray/10 bg-gray/[8%] px-3.5">
                        <span>@site.com</span>
                    </div>
                </label>
                <label class="flex">
                    <div class="flex items-center justify-center rounded-l border-r-0 border-2 border-gray/10 bg-gray/[8%] px-3.5">
                        <span>$</span>
                    </div>
                    <input id="user3" class="form-input rounded-none" placeholder="Enter Price" type="text">
                    <div class="flex items-center justify-center border-l-0 rounded-r border-2 border-gray/10 bg-gray/[8%] px-3.5">
                        <span>.00</span>
                    </div>
                </label>
            </form>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <form class="space-y-4">
                <div class="flex -space-x-px">
                    ...
                    <div class="flex items-center justify-center px-3.5 border-2 border-gray/10 bg-gray/[8%]">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <form class="space-y-4">
                <label class="flex">
                    <div class="flex items-center border-r-0 justify-center rounded-l border-2 border-primary bg-primary text-white px-3.5">
                        <span>
                ...
                <label class="flex">
                    ...
                    <div class="flex items-center justify-center border-l-0 rounded-r border-2 border-primary bg-primary text-white px-3.5">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3" d="M18.7491 9V9.7041C18.7491 10.5491 18.9903 11.3752 19.4422 12.0782L20.5496 13.8012C21.5612 15.3749 20.789 17.5139 19.0296 18.0116C14.4273 19.3134 9.57274 19.3134 4.97036 18.0116C3.21105 17.5139 2.43882 15.3749 3.45036 13.8012L4.5578 12.0782C5.00972 11.3752 5.25087 10.5491 5.25087 9.7041V9C5.25087 5.13401 8.27256 2 12 2C15.7274 2 18.7491 5.13401 18.7491 9Z" fill="currentColor"></path>
                                <path d="M12.75 6C12.75 5.58579 12.4142 5.25 12 5.25C11.5858 5.25 11.25 5.58579 11.25 6V10C11.25 10.4142 11.5858 10.75 12 10.75C12.4142 10.75 12.75 10.4142 12.75 10V6Z" fill="currentColor"></path>
