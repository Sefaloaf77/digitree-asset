            ...
            <div class="togglebutton out-line inline-block">
                <label for="toggleD3" class="flex items-center cursor-pointer">
                    <div class="relative">
                        ...
                        <div class="dot absolute left-1 top-[3.5px] bg-gray/20 w-[22PX] h-[22PX] transition"></div>
                    </div>
                </label>
            </div>
        </div>
            ...
            <div class="togglebutton out-line inline-block">
                <label for="toggleD4" class="flex items-center cursor-pointer">
                    <div class="relative">
                        ...
                        <div class="dot absolute left-[5px] top-[3.5px] bg-gray/20 w-[22PX] h-[22PX] rounded-full transition"></div>
                    </div>
                </label>
            </div>
        </div>
