        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            <div
                ...
                <div class="p-5 space-y-4">
                    <form action="{{ route('dashboard.user-role.store') }}" id="modalForm" method="POST"
                        ...
                        <div class="w-full space-y-4 mt-4">
                            ...
                            <select
                                ...
                                id="role" name="role" autocomplete="role" aria-placeholder="Pilih Role User">
                    ...
                    <div class="flex justify-between items-center gap-3 w-full">
                        <div class="flex space-x-2 items-center">
                            ...
                            <select id="filter" class="form-select !w-20"
                                onchange="window.location.href='{{ route('dashboard.user-role.index') }}?per_page='+this.value">>
                        ...
                        <table class="min-w-[640px] w-full display" id="table">
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                onclick="window.location.href='{{ route('dashboard.user-role.index') }}?sort_by=name&sort_direction={{ $sortDirection == 'asc' ? 'desc' : 'asc' }}'">
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                onclick="window.location.href='{{ route('dashboard.user-role.index') }}?sort_by=role&sort_direction={{ $sortDirection == 'asc' ? 'desc' : 'asc' }}'">
                                                <path d="M5 15l7-7 7 7"></path>
                                            </svg>
                                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="4" viewBox="0 0 24 24" stroke="currentColor"
                                                ...
                                                onclick="window.location.href='{{ route('dashboard.user-role.index') }}?sort_by=kecamatan&sort_direction={{ $sortDirection == 'asc' ? 'desc' : 'asc' }}'">
                                                <path d="M19 18l-7 7-7-7"></path>
                                            </svg>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                onclick="window.location.href='{{ route('dashboard.user-role.index') }}?sort_by=email&sort_direction={{ $sortDirection == 'asc' ? 'desc' : 'asc' }}'">
                                                <path d="M5 15l7-7 7 7"></path>
                                            </svg>
                                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="4" viewBox="0 0 24 24" stroke="currentColor"
                                                ...
                                                onclick="window.location.href='{{ route('dashboard.user-role.index') }}?sort_by=kab_kota&sort_direction={{ $sortDirection == 'asc' ? 'desc' : 'asc' }}'">
                                                <path d="M19 18l-7 7-7-7"></path>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                @foreach ($user as $item)
                                    <tr class="">
                                        <td>
                                            <span>{{ ($user->currentPage() - 1) * $user->perPage() + $loop->iteration }}</span>
                                        </td>
                                        <td>
                                            <span>{{ $item->name }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="flex gap-2 items-center">
                                                <a href="{{ route('dashboard.user-role.edit', ['id' => $item->id]) }}"
                                                    class="py-2 px-3 text-white bg-blue-btn rounded-lg cursor-pointer self-center">Edit</a>

                                                <form
                                                    action="{{ route('dashboard.user-role.delete', ['id' => $item->id]) }}"
...
@section('script')
    ...
    <script>
        ...
        function toggle(params) {
            ...
            if (params == 'Tambah') {
                titleModal.textContent = "Tambah User";
            } else if (params == 'Edit') {
