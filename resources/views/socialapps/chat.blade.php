...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1 gap-4" x-data="chat">
        <div class="flex gap-5 relative overflow-hidden">
            <div class="bg-white border-2 border-lightgray/10 rounded-l-lg xl:rounded-lg py-5 absolute w-72 sm:w-[410px] z-20 flex-none -left-[410px] xl:static overflow-hidden" :class="isShowChatMenu && '!left-0'">
                <div class="px-5">
            ...
            <div class="bg-dark/90 backdrop-blur-sm lg:hidden z-[5] w-full h-full absolute rounded-md hidden" :class="isShowChatMenu && '!block xl:!hidden'" @click="isShowChatMenu = !isShowChatMenu"></div>
            <div class="bg-white border-2 border-lightgray/10 rounded-lg flex-grow min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
                <div class="flex items-center gap-2 justify-between border-b-[2px] border-lightgray/10 p-5">
                ...
                <div class="p-5 pt-0">
                    <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg p-3 lg:p-5 flex items-center gap-3 md:gap-5">
                        ...
                        <form class="w-full">
                            <div class="relative">
                                <input type="text" id="search" class="form-input border-0 pe-10 h-14 bg-dark/[4%] rounded-lg text-sm text-dark placeholder:text-lightgray/80 focus:ring-0 focus:border-primary/80 focus:outline-0" placeholder="Type message here..." required="">
