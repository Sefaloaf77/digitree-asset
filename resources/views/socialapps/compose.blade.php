...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1 gap-4 flex-1" x-data="email">
        <div class="flex gap-5 items-stretch relative overflow-hidden" x-data="{activeTab:'compose'}">
            <div class="bg-white border-2 border-lightgray/10 rounded-l-lg xl:rounded-lg p-5 absolute w-[200px] z-20 flex-none -left-[410px] xl:static overflow-hidden overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]" :class="isShowChatMenu && '!left-0'">
            ...
            <div class="bg-dark/90 backdrop-blur-sm lg:hidden z-[5] w-full h-full absolute rounded-lg hidden" :class="isShowChatMenu && '!block xl:!hidden'" @click="isShowChatMenu = !isShowChatMenu"></div>
            <div x-show="activeTab === 'compose'" class="flex flex-row items-start gap-4 relative w-full">
                <div class="w-full flex flex-col flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                    <div class="p-5 border-b-2 border-lightgray/10">
                        <div class="flex items-center gap-5">
                    ...
                    <div class="p-5 border-b-2 border-lightgray/10">
                        <div class="flex items-center gap-5">
                            ...
                            <input type="text" id="inputSubject1" placeholder="Type Subject" class="form-control w-full text-sm p-0 !border-none placeholder:text-gray focus:ring-0 bg-transparent">
                        </div>
                    </div>
                    <div class="p-5 border-b-2 border-lightgray/10 flex-1">
                        <textarea id="textareaMail" class="form-control w-full h-full text-sm p-0 !border-none placeholder:text-gray focus:ring-0 bg-transparent" placeholder="Type Message:"></textarea>
                    </div>
            ...
            <div x-show="activeTab === 'inbox'" x-data="{selectedMail: false}" class="flex flex-row items-start gap-4 relative w-full h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            <button type="button" class="xl:hidden hover:text-primary duration-300" @click="isShowChatMenu = !isShowChatMenu">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input type="checkbox" id="checkboxMail1" class="form-checkbox m-0">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail1" class="form-checkbox m-0">
                        ...
                        <div class="h-[2px] bg-lightgray/10 w-full"></div>
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail2 class="form-checkbox m-0">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail3" class="form-checkbox m-0">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail4" class="form-checkbox m-0">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail5" class="form-checkbox m-0">
                ...
                <div class="flex-1 flex flex-col gap-2 justify-between overflow-y-auto rounded-lg absolute top-0 -right-full w-full bg-white border-2 border-lightgray/10 md:static h-full" :class="selectedMail && '!right-0'">
                    <div>
                            ...
                            <div class="flex items-center gap-5 justify-between flex-wrap">
                                <div class="flex items-center gap-3.5 flex-1">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex items-center gap-5">
                                            <p class="text-gray text-xs">To: <span class="text-dark font-semibold">You</span></p>
                                            <p class="text-gray text-xs">Cc: <span class="text-dark font-semibold">You</span></p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <input type="checkbox" id="checkboxSendMail16" class="form-checkbox m-0">
                            <p class="font-semibold line-clamp-1">Mail Inbox <span class="text-xs">20 messages </span></p>
                        </div>
                        <div class="flex items-center gap-5">
                            <button type="button" class="h-5 w-5 flex items-center justify-center duration-300 hover:text-primary text-lightgray">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail6" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-11.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail7" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-2.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                ...
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <input type="checkbox" id="checkboxSendMail8" class="form-checkbox m-0">
                            <p class="font-semibold line-clamp-1">Mail Inbox <span class="text-xs">20 messages </span></p>
                        </div>
                        <div class="flex items-center gap-5">
                            <button type="button" class="h-5 w-5 flex items-center justify-center duration-300 hover:text-primary text-lightgray">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail9" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-10.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail10" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-2.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                ...
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <input type="checkbox" id="checkboxSendMail11" class="form-checkbox m-0">
                            <p class="font-semibold line-clamp-1">Mail Inbox <span class="text-xs">20 messages </span></p>
                        </div>
                        <div class="flex items-center gap-5">
                            <button type="button" class="h-5 w-5 flex items-center justify-center duration-300 hover:text-primary text-lightgray">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail12" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-13.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail13" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-10.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSelectMail" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-11.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                ...
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <input type="checkbox" id="checkboxmailbox" class="form-checkbox m-0">
                            <p class="font-semibold line-clamp-1">Mail Inbox <span class="text-xs">20 messages </span></p>
                        </div>
                        <div class="flex items-center gap-5">
                            <button type="button" class="h-5 w-5 flex items-center justify-center duration-300 hover:text-primary text-lightgray">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSelectMail2" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-10.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSelectMail3" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-2.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                ...
                <div class="lg:max-w-[300px] xl:max-w-md w-full flex-1 rounded-lg bg-white border-2 border-lightgray/10 overflow-hidden">
                    <div class="bg-white border-b-2 border-lightgray/10 p-5 flex justify-between items-center gap-2.5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <input type="checkbox" id="checkboxMailInbox1" class="form-checkbox m-0">
                            <p class="font-semibold line-clamp-1">Mail Inbox <span class="text-xs">20 messages </span></p>
                        </div>
                        <div class="flex items-center gap-5">
                            <button type="button" class="h-5 w-5 flex items-center justify-center duration-300 hover:text-primary text-lightgray">
                    ...
                    <div class="overflow-y-auto h-[calc(100vh-258px)] sm:h-[calc(100vh-274px)] ">
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSelectedMail2" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-13.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
                        ...
                        <button class="w-full duration-300 p-5" @click="selectedMail = !selectedMail">
                            <div class="flex items-start gap-3.5">
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <input type="checkbox" id="checkboxSendMail20" class="form-checkbox m-0">
                                    <img src="{{ asset('assets/images/avatar-10.png') }}" class="w-[42px] h-[42px] rounded-full" alt="">
                                </div>
                                <div class="text-left flex-1">
                                    <div class="flex items-center gap-1 justify-between">
