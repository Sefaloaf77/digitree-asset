    ...
    <div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg space-y-6">
                    <div class="flex items-center gap-2.5"><span><svg width="24"height="24" viewBox="0 0 24 24"
                    ...
                    <div class="flex items-center gap-2.5 xl:gap-[30px] flex-wrap"><span
                            class="text-lg font-bold">404K</span>
                        <p class="flex items-center gap-2.5 text-gray flex-wrap">This week<span
                                class="bg-success/10 text-success flex items-center gap-1 rounded-full py-1 px-2.5 text-xs">3.47%<span
                                    class=""><svg width="10"height="10" class="inline-block" viewBox="0 0 10 10"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg space-y-6">
                    <div class="flex items-center gap-2.5"><span><svg width="24"height="24" viewBox="0 0 24 24"
                                ...
                                <ellipse opacity="0.3"cx="16" cy="17" rx="5" ry="3"
                                    fill="#7B6AFE" />
                    ...
                    <div class="flex items-center gap-2.5 xl:gap-[30px] flex-wrap"><span
                            class="text-lg font-bold">300K</span>
                        <p class="flex items-center gap-2.5 text-gray flex-wrap">This week<span
                                class="bg-danger/10 text-danger flex items-center gap-1 rounded-full py-1 px-2.5 text-xs">2.14%<span
                                    class=""><svg width="11"height="10" viewBox="0 0 11 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M6.23684 0.789474C6.23684 0.353459 5.88338 0 5.44737 0C5.01135 0 4.65789 0.353459 4.65789 0.789474L4.65789 7.30457L2.84772 5.49439C2.53941 5.18608 2.03954 5.18608 1.73123 5.49439C1.42292 5.8027 1.42292 6.30257 1.73123 6.61087L4.88913 9.76877C5.03718 9.91682 5.23799 10 5.44737 10C5.65675 10 5.85756 9.91682 6.00561 9.76877L9.16351 6.61087C9.47181 6.30257 9.47181 5.8027 9.16351 5.49439C8.8552 5.18608 8.35533 5.18608 8.04702 5.49439L6.23684 7.30457V0.789474Z"
                                            fill="currentColor" />
                                    </svg></span></span></p>
                    </div>
                </div>
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg space-y-6">
                    ...
                    <div class="flex items-center gap-2.5 xl:gap-[30px] flex-wrap"><span
                            class="text-lg font-bold">340K</span>
                        <p class="flex items-center gap-2.5 text-gray flex-wrap">This week<span
                                class="bg-danger/10 text-danger flex items-center gap-1 rounded-full py-1 px-2.5 text-xs">1.42%<span
                                    class=""><svg width="11"height="10" viewBox="0 0 11 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M6.23684 0.789474C6.23684 0.353459 5.88338 0 5.44737 0C5.01135 0 4.65789 0.353459 4.65789 0.789474L4.65789 7.30457L2.84772 5.49439C2.53941 5.18608 2.03954 5.18608 1.73123 5.49439C1.42292 5.8027 1.42292 6.30257 1.73123 6.61087L4.88913 9.76877C5.03718 9.91682 5.23799 10 5.44737 10C5.65675 10 5.85756 9.91682 6.00561 9.76877L9.16351 6.61087C9.47181 6.30257 9.47181 5.8027 9.16351 5.49439C8.8552 5.18608 8.35533 5.18608 8.04702 5.49439L6.23684 7.30457V0.789474Z"
                ...
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg space-y-6">
                    ...
                    <div class="flex items-center gap-2.5  xl:gap-[30px] flex-wrap"><span
                            class="text-lg font-bold">140K</span>
                        <p class="flex items-center gap-2.5 text-gray flex-wrap">This week<span
                                class="bg-success/10 text-success flex items-center gap-1 rounded-full py-1 px-2.5 text-xs">6.70%<span
                                    class=""><svg width="10"height="10" class="inline-block" viewBox="0 0 10 10"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5.73684 9.21053C5.73684 9.64654 5.38338 10 4.94737 10C4.51135 10 4.15789 9.64654 4.15789 9.21053L4.15789 2.69543L2.34772 4.50561C2.03941 4.81392 1.53954 4.81392 1.23123 4.50561C0.922923 4.1973 0.922923 3.69743 1.23123 3.38913L4.38913 0.231232C4.53718 0.0831764 4.73799 -1.83028e-08 4.94737 0C5.15675 1.83066e-08 5.35756 0.0831765 5.50561 0.231232L8.66351 3.38913C8.97181 3.69743 8.97181 4.1973 8.66351 4.50561C8.3552 4.81392 7.85533 4.81392 7.54702 4.50561L5.73684 2.69543V9.21053Z"
            ...
            <div class="grid md:grid-cols-2 gap-5">
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                    ...
                    <p class="text-lightgray">Aug 25-Sep 25<span><svg width="20"height="20" class="inline-block"
                                viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.91895 10.337L9.69134 13.1959C9.86896 13.3791 10.1311 13.3791 10.3087 13.1959L15.6668 7.67055C16.0011 7.32577 15.7984 6.66666 15.3581 6.66666H10.5893L6.91895 10.337Z"
                                    fill="currentColor" />
                                <path opacity="0.5"
                                    d="M9.41073 6.66666H4.64191C4.20156 6.66666 3.9989 7.32577 4.33324 7.67055L6.33873 9.73866L9.41073 6.66666Z"
                                    fill="currentColor" />
                            </svg></span></p>
                ...
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 items-center gap-5">
                        ...
                        <div>
                            ...
                            <div x-data="{ dropdown: false }"class="dropdown ml-auto mt-2"><a
                                    href="javaScript:;"class="text-lightgray h-3 flex items-center z-0"
                                    @click="dropdown = !dropdown"@keydown.escape="dropdown = false"><svg
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                ...
                <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                    ...
                    <div class="grid sm:grid-cols-3 gap-5">
                        <div class="flex items-center gap-2 md:gap-3.5 flex-wrap">
                            <div class="relative w-12 h-12"><svg viewbox="0 0 36 36"class="block my-0 mx-auto w-12 h-12">
                                    <path class="fill-none stroke-primary/20 stroke-[4]"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="fill-none stroke-primary stroke-[4]"stroke-dasharray="80, 100"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                </svg><svg class="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2"width="12"
                                    height="12"viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.8 1.20001L1.20001 10.8M1.20001 10.8V1.20001M1.20001 10.8H10.8"
                        ...
                        <div class="flex items-center gap-2 md:gap-3.5 flex-wrap">
                            <div class="relative w-12 h-12"><svg viewbox="0 0 36 36"class="block my-0 mx-auto w-12 h-12">
                                    <path class="fill-none stroke-purple/20 stroke-[4]"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="fill-none stroke-purple stroke-[4]"stroke-dasharray="40, 100"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                </svg><svg class="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2"width="12"
                                    height="12"viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.20896 10.8L10.8 1.2M10.8 1.2V10.8M10.8 1.2H1.20896" stroke="currentColor"
                        ...
                        <div class="flex items-center gap-2 md:gap-3.5 flex-wrap">
                            <div class="relative w-12 h-12"><svg viewbox="0 0 36 36"class="block my-0 mx-auto w-12 h-12">
                                    <path class="fill-none stroke-orange/20 stroke-[4]"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="fill-none stroke-orange stroke-[4]"stroke-dasharray="30, 100"
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                </svg><svg class="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2"width="12"
                                    height="12"viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.20896 10.8L10.8 1.2M10.8 1.2V10.8M10.8 1.2H1.20896" stroke="currentColor"
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                ...
                <div class="space-y-5"><img src="{{ asset('assets/images/map-light.png') }}"class="dark:hidden mx-auto"
                        alt=""><img
                        src="{{ asset('assets/images/map-dark.png') }}"class="dark:block hidden mx-auto" alt="">
                        ...
                        <div class="space-y-[30px]">
                            <div class="grid grid-cols-9 gap-5 items-center">
                                ...
                                <div class="w-full h-2 bg-orange/10 rounded-md col-span-7">
                                    <div
                                        class="bg-orange h-2 rounded-md w-11/12 text-center flex justify-center items-center">
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-9 gap-5 items-center">
                                ...
                                <div class="w-full h-2 bg-primary/10 rounded-md col-span-7">
                                    <div
                                        class="bg-primary h-2 rounded-md w-9/12 text-center flex justify-center items-center">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-[30px]">
                            <div class="grid grid-cols-9 gap-5 items-center">
                                ...
                                <div class="w-full h-2 bg-purple/10 rounded-md col-span-7">
                                    <div
                                        class="bg-purple h-2 rounded-md w-9/12 text-center flex justify-center items-center">
                                    </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-9 gap-5 items-center">
                                ...
                                <div class="w-full h-2 bg-warning/10 rounded-md col-span-7">
                                    <div
                                        class="bg-warning h-2 rounded-md w-6/12 text-center flex justify-center items-center">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                ...
                <div class="overflow-auto">
                    <table class="min-w-[640px] w-full product-table">
                        <thead>
                            <tr class="text-left">
                                <th><input type="checkbox"id="checkboxWebsite" class="form-checkbox"></th>
                                <th>Website<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <th>Asset Name<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                                    </svg></th>
                                <th>Status<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                                    </svg></th>
                                <th>Categories<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                                    </svg></th>
                                <th>Tags<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                                    </svg></th>
                                <th>Date<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                                    </svg></th>
                                <th>Country<svg width="10"height="6" class="inline-block" viewBox="0 0 10 6"
                                        fill="none"xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.70711 1.70711C10.0976 1.31658 10.0976 0.683418 9.70711 0.292894C9.31658 -0.0976307 8.68342 -0.0976308 8.29289 0.292894L5 3.58579L1.70711 0.292893C1.31658 -0.097631 0.683417 -0.0976311 0.292893 0.292893C-0.0976309 0.683417 -0.097631 1.31658 0.292893 1.70711L4.29289 5.70711C4.68342 6.09763 5.31658 6.09763 5.70711 5.70711L9.70711 1.70711Z"
                                            fill="currentColor" />
                        ...
                        <tbody>
                            ...
                            <tr class="text-left">
                                <td><input type="checkbox"id="checkboxAmazon" class="form-checkbox"></td>
                                <td>Amazon</td>
                                <td>
                                    <div class="flex items-center gap-2.5"><img
                                            src="{{ asset('assets/images/assets/2.png') }}"class="w-[50px] rounded-full"
                                            alt="">
                                        <p class="line-clamp-1 max-w-[200px] truncate">Abstract Minimalist Character</p>
                                    </div>
                                </td>
                                <td><span
                                        class="bg-success text-white font-bold text-sm py-1.5 px-3 rounded-full">Public</span>
                                </td>
                                <td>
                                    <div class="flex items-center gap-2"><span class="text-gray"><svg
                            ...
                            <tr class="text-left">
                                <td><input type="checkbox"id="checkboxFacebook" class="form-checkbox"></td>
                                <td>Facebook</td>
                                <td>
                                    <div class="flex items-center gap-2.5"><img
                                            src="{{ asset('assets/images/assets/3.png') }}"class="w-[50px] rounded-full"
                                            alt="">
                            ...
                            <tr class="text-left">
                                <td><input type="checkbox"id="checkboxInstagram" class="form-checkbox"></td>
                                <td>Instagram</td>
                                <td>
                                    <div class="flex items-center gap-2.5"><img
                                            src="{{ asset('assets/images/assets/4.png') }}"class="w-[50px] rounded-full"
                                            alt="">
                                ...
                                <td>
                                    <div class="flex items-center gap-2"><span class="text-gray"><svg
                                                ...
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M16 5.2L21.213 1.55C21.288 1.49746 21.3759 1.4665 21.4672 1.4605C21.5586 1.4545 21.6498 1.4737 21.731 1.51599C21.8122 1.55829 21.8802 1.62206 21.9276 1.70035C21.9751 1.77865 22.0001 1.86846 22 1.96V14.04C22.0001 14.1315 21.9751 14.2214 21.9276 14.2996C21.8802 14.3779 21.8122 14.4417 21.731 14.484C21.6498 14.5263 21.5586 14.5455 21.4672 14.5395C21.3759 14.5335 21.288 14.5025 21.213 14.45L16 10.8V15C16 15.2652 15.8946 15.5196 15.7071 15.7071C15.5196 15.8946 15.2652 16 15 16H1C0.734784 16 0.48043 15.8946 0.292893 15.7071C0.105357 15.5196 0 15.2652 0 15V1C0 0.734784 0.105357 0.48043 0.292893 0.292893C0.48043 0.105357 0.734784 0 1 0H15C15.2652 0 15.5196 0.105357 15.7071 0.292893C15.8946 0.48043 16 0.734784 16 1V5.2ZM16 8.359L20 11.159V4.84L16 7.64V8.358V8.359ZM2 2V14H14V2H2ZM4 4H6V6H4V4Z"
                                                    fill="currentColor" />
                                            </svg></span>
