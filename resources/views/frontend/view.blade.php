...
@section('konten-frontend')
    ...
    {{-- Splash GIF --}}
    <div id="splashScreen">
        <img src="{{ asset('images/openingv3.gif') }}" alt="Loading..." class="max-w-full max-h-full">
    </div>

    {{-- Konten utama --}}
    <div id="mainContent" class="hidden">
        {{-- taruh semua konten utama kamu di sini --}}
            ...
            <div id="modalMapChoice" class="fixed inset-0 bg-black/60 z-[99999] flex items-center justify-center hidden">
                <div class="bg-white rounded-lg shadow-xl max-w-sm w-full p-5 relative">
                    ...
                    <div class="flex gap-4 justify-center">
                        <a id="btnMapAll" href="http://192.168.11.93:3039/maps"
                            class="bg-slate-500 text-white px-4 py-2 rounded flex-1 text-center font-semibold">Lihat Semua
                            Area</a>
                        <a id="btnMapFocus" href="#"
                            class="bg-green-digitree text-white px-4 py-2 rounded flex-1 text-center font-semibold">Ke Area
                            Ini</a>
                    </div>
                ...
                <div class="w-full px-5 py-8">
                    ...
                    <div class="my-4">
                        ...
                        <a onclick="modalDeskripsi()"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 stroke-green-digitree"
                                viewBox="0 0 24 24">
    ...
    <script>
        function showMapChoice(areaLabel) {
            ...
            document.getElementById('btnMapFocus').href =
                areaLabel ?
                `http://192.168.11.93:3039/maps?focus=${encodeURIComponent(areaLabel)}` :
                `http://192.168.11.93:3039/maps`;
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            setTimeout(() => {
                ...
                // mulai fade out splash
                splash.classList.add("fade-out");

                // tunggu animasi splash selesai baru tampilkan konten
                setTimeout(() => {
                    splash.style.display = "none";
                    main.classList.remove("hidden");
                    main.classList.add("fade-in");
                }, 1000); // sesuai durasi transition splash
            }, 5000); // tampil 5 detik dulu
        });
    </script>
@endpush
