    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div x-data="{ toastVisible: false, toastTimer: null }">
                <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] fixed bottom-5 right-5 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div x-data="{ notificationOpen: false }">
                ...
                <div x-show="notificationOpen" class="bg-dark flex items-start gap-3 text-white py-3 px-4 rounded-md max-w-[250px] fixed bottom-5 right-5 z-[99999]" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    <span>Hello, world! This is a toast message.</span>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] fixed top-5 left-5 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <span>Hello, world! This is a toast message.</span>
                    </div>
                ...
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] mx-auto fixed top-5 left-0 right-0 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <span>Hello, world! This is a toast message.</span>
                    </div>
                    <button class="btn hover:bg-gray/10 border border-gray/10 rounded-md transition-all duration-300" x-on:click="
                        if (toastVisible) {
                ...
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] fixed top-5 right-5 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <span>Hello, world! This is a toast message.</span>
                    </div>
                    <button class="btn hover:bg-gray/10 border border-gray/10 rounded-md transition-all duration-300" x-on:click="
                        if (toastVisible) {
                ...
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] mx-auto fixed bottom-5 right-0 left-0 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <span>Hello, world! This is a toast message.</span>
                    </div>
                    <button class="btn hover:bg-gray/10 border border-gray/10 rounded-md transition-all duration-300" x-on:click="
                        if (toastVisible) {
                ...
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    <div x-clock x-show="toastVisible" class="bg-dark text-white py-3 px-4 rounded-md max-w-[240px] fixed bottom-5 left-5 z-[99999]" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                        <span>Hello, world! This is a toast message.</span>
                    </div>
                    <button class="btn hover:bg-gray/10 border border-gray/10 rounded-md transition-all duration-300" x-on:click="
                        if (toastVisible) {
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                ...
                <div x-data="{ toastVisible: false, toastTimer: null }">
                    ...
                    <button class="btn border border-transparent rounded-md  transition-all duration-300 hover:text-white hover:bg-dark bg-dark/10" x-on:click="
                        if (toastVisible) {
                            clearTimeout(toastTimer);
                            toastTimer = setTimeout(() => toastVisible = false, 3000);
                        } else {
