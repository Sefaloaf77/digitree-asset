    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div x-data="{activeDefTab:'profile'}">
                <ul class="flex flex-wrap text-sm text-center border-b border-lightgray/10">
                    <li class="mr-2">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div x-data="{activeDefTab:'profile'}">
                <ul class="sm:flex w-full md:overflow-scroll lg:overflow-hidden text-sm text-center border-b border-lightgray/10">
                    <li class="w-full">
