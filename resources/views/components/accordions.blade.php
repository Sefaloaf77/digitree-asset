...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="space-y-2" x-data="{ current: 1 }">
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex items-center text-gray" :class="{'!text-dark' : current === 1}" x-on:click="current === 1 ? current = null : current = 1">
                        Accordion Item #1
                    ...
                    <div x-cloak x-show="current === 1" x-collapse>
                        <div class="space-y-2 p-4 text-lightgray text-sm font-normal border-t-2 border-lightgray/10">
                            <p>
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex items-center text-gray" :class="{'!text-dark' : current === 2}" x-on:click="current === 2 ? current = null : current = 2">
                        Accordion Item #2
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex items-center text-gray" :class="{'!text-dark' : current === 3}" x-on:click="current === 3 ? current = null : current = 3">
                        Accordion Item #3
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div x-data="{ current: 1 }" class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg divide-y-2 divide-lightgray/10">
                <div>
                    <button type="button" class="p-4 w-full flex items-center text-gray" :class="{'!text-dark' : current === 1}" x-on:click="current === 1 ? current = null : current = 1">
                        Accordion Item #1
                        <div class="ml-auto" :class="{'rotate-180' : current === 1}">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="space-y-2" x-data="{ current: 1 }">
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg overflow-hidden">
                    <button type="button" class="p-4 w-full flex items-center text-gray bg-gray/5" :class="{'!text-dark bg-lightgray/10' : current === 1}" x-on:click="current === 1 ? current = null : current = 1">
                        Accordion Item #1
                        <div class="ml-auto" :class="{'rotate-180' : current === 1}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                <path fill="currentColor" d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z"></path>
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg overflow-hidden">
                    <button type="button" class="p-4 w-full flex items-center text-gray bg-gray/5" :class="{'!text-dark bg-lightgray/10' : current === 2}" x-on:click="current === 2 ? current = null : current = 2">
                        Accordion Item #2
                        <div class="ml-auto" :class="{'rotate-180' : current === 2}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                <path fill="currentColor" d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z"></path>
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg overflow-hidden">
                    <button type="button" class="p-4 w-full flex items-center text-gray bg-gray/5" :class="{'!text-dark bg-lightgray/10' : current === 3}" x-on:click="current === 3 ? current = null : current = 3">
                        Accordion Item #3
                        <div class="ml-auto" :class="{'rotate-180' : current === 3}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                <path fill="currentColor" d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z"></path>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="space-y-2" x-data="{ current: 1 }">
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex gap-2.5 items-center text-gray" :class="{'!text-dark' : current === 1}" x-on:click="current === 1 ? current = null : current = 1">
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex gap-2.5 items-center text-gray" :class="{'!text-dark' : current === 2}" x-on:click="current === 2 ? current = null : current = 2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 256 256">
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full flex gap-2.5 items-center text-gray" :class="{'!text-dark' : current === 3}" x-on:click="current === 3 ? current = null : current = 3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="space-y-2" x-data="{ current: 1 }">
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full text-start text-gray" :class="{'!text-dark' : current === 1}" x-on:click="current === 1 ? current = null : current = 1">
                        Accordion Item #1
                    </button>
                    <div x-cloak x-show="current === 1" x-collapse>
                        <div class="space-y-2 p-4 text-lightgray text-sm font-normal border-t-2 border-lightgray/10">
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full text-start text-gray" :class="{'!text-dark' : current === 2}" x-on:click="current === 2 ? current = null : current = 2">
                        Accordion Item #2
                    </button>
                    <div x-cloak x-show="current === 2" x-collapse>
                        <div class="space-y-2 p-4 text-lightgray text-sm font-normal border-t-2 border-lightgray/10">
                ...
                <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                    <button type="button" class="p-4 w-full text-start text-gray" :class="{'!text-dark' : current === 3}" x-on:click="current === 3 ? current = null : current = 3">
                        Accordion Item #3
                    </button>
                    <div x-cloak x-show="current === 3" x-collapse>
                        <div class="space-y-2 p-4 text-lightgray text-sm font-normal border-t-2 border-lightgray/10">
