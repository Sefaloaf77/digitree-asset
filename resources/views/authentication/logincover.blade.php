                ...
                <div class="p-10 flex flex-col w-full lg:w-1/2 pt-44 lg:py-[132px] justify-center">
                    <div class="max-w-[500px] mx-auto w-full">
                        ...
                        <form class="mt-[60px] space-y-5">
                            <div class="relative">
                                <input id="inputemail" type="email" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Email ID">
                            ...
                            <div class="relative">
                                <input id="inputpassword" type="password" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Password">
                                <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
