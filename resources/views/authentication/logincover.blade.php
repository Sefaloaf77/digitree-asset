        ...
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between absolute w-full flex-wrap gap-5">
                <a href="{{ route('index') }}" class="main-logo">
                    ...
                    <img src="{{ asset('assets/images/logo-light.svg') }}" class="light-logo h-8 logo hidden"
                        alt="logo" />
                </a>
                <div class="flex items-center gap-4">
                    <div
                        class="text-lightgray lg:text-white lg:hover:text-white hover:text-primary duration-300 md:block hidden">
                    ...
                    <p class="lg:bg-white/10 bg-primary text-white p-3.5 rounded-lg">Don't have an account? <a
                            href="{{ route('signinCover') }}" class="font-semibold underline underline-offset-4">Sign Up for
                            Free</a></p>
                </div>
            </div>
            <div class="min-h-screen place-content-center flex">
                <div class="flex w-full">
                    <div class="p-10 flex flex-col w-full lg:w-1/2 pt-44 lg:py-[132px] justify-center">
                        <div class="max-w-[500px] mx-auto w-full">
                            ...
                            <form class="mt-[60px] space-y-5">
                                <div class="relative">
                                    <input id="inputemail" type="email"
                                        class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14"
                                ...
                                <div class="flex items-center gap-2 justify-between flex-wrap">
                                    ...
                                    <span>
                                        <a href="{{ route('resetPasswordCover') }}"
                                            class="hover:text-primary duration-300">Forgot Password?</a>
                                    </span>
                                </div>
                                <div class="!mt-[50px]">
                                    <button type="button"
                            ...
                            <div class="mt-[30px] flex items-center justify-between gap-2.5 flex-wrap">
                                <a href="javascript:;"
                                    class="flex items-center text-sm font-semibold bg-gray/10 justify-center p-3.5 gap-3.5 border-2 border-gray/10 rounded-[10px] flex-1 hover:bg-gray/20 duration-300">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_645_8948)">
                                            ...
                                            <path
                                                ...
                                                fill="#34A853" />
                                            <path
                                                d="M6.00253 14.3003C5.49987 12.8099 5.49987 11.1961 6.00253 9.70575V6.61481H2.01649C0.31449 10.0056 0.31449 14.0004 2.01649 17.3912L6.00253 14.3003V14.3003Z"
                                                fill="#FBBC04" />
                                            <path
                    ...
                    <div
                        class="hidden lg:flex w-1/2 bg-primary flex-col py-[132px] justify-center bg-[url('../images/bg-cover.png')] bg-cover bg-no-repeat bg-center">
                        <div>
                            <img src="{{ asset('assets/images/login-cover.png') }}" class="mx-auto" alt="">
                            <div class="max-w-[500px] mx-auto w-full px-4">
                                <p class="text-sm font-semibold text-white/60 uppercase tracking-widest mt-4">contrary to
                                    popular belief</p>
                                <p class="text-[22px]/9 text-white mt-4">Lorem Ipsum is simply dummy text of the printing
