...
<div class="bg-white text-dark bg-[url('../images/autho-light-bg.png')]'../images/autho-dark-bg.png')] bg-fixed bg-cover bg-center min-h-screen">
    <!-- Start Content -->
    <div class="relative">
        ...
        <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
            <div class="sm:p-[60px] p-9 border-2 border-gray/10 bg-white/10 backdrop-blur-3xl max-w-[620px] mx-auto rounded-lg w-full">
                ...
                <form class="mt-[60px] space-y-5">
                    <div class="flex flex-row gap-1.5 sm:gap-4 justify-between">
                        <input type="text" id="code1" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                        <input type="text" id="code2" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                        <input type="text" id="code3" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                        <input type="text" id="code4" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                        <input type="text" id="code5" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                        <input type="text" id="code6" class="form-input h-[66px] bg-transparent text-base rounded-[10px] p-2 text-center flex-1" maxlength="1">
                    </div>
                    ...
                    <div class="mt-[30px] flex items-center gap-5">
                        ...
                        <button type="button" class="btn border-2 border-gray/10 bg-gray/10 py-6 uppercase tracking-widest font-bold text-sm rounded-[10px] w-1/2 sm:w-1/3 hover:bg-gray/20 duration-300">
                            Cancel
                        </button>
                    </div>
                </form>
