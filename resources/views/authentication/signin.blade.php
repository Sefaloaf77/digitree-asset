    ...
    <div class="relative">
        <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
            ...
            <div class="flex items-center gap-5">
                ...
                <p>Already have an account? <a href="{{ route('login') }}" class="font-semibold underline underline-offset-4 text-success">Login</a></p>
            </div>
        </div>
        <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
            <div class="sm:p-[60px] p-9 border-2 border-gray/10 bg-white/10 backdrop-blur-3xl max-w-[620px] mx-auto rounded-lg w-full">
                ...
                <form class="mt-[60px] space-y-5">
                    <div class="relative">
                        <input type="text" id="fullnameinput" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Full Name">
                        <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12" cy="6" r="4" fill="currentColor"></circle>
                                <ellipse opacity="0.3" cx="12" cy="17" rx="7" ry="4" fill="currentColor"></ellipse>
                            </svg>
                        </span>
                    </div>
                    <div class="relative">
                        <input type="email" id="emailinput" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Email ID">
                        <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="relative">
                        <input type="password" id="passwordinput" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Password">
                        <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex items-center gap-2.5 mt-[30px]">
                    <div class="h-[2px] bg-gray/10 flex-1"></div>
                    <span class="shrink-0 text-gray text-sm">Or Login with</span>
                    <div class="h-[2px] bg-gray/10 flex-1"></div>
                </div>
                <div class="mt-[30px] flex items-center justify-between gap-2.5 flex-wrap">
                    <a href="javascript:;" class="flex items-center text-sm font-semibold bg-gray/10 justify-center p-3.5 gap-3.5 border-2 border-gray/10 rounded-[10px] flex-1 hover:bg-gray/20 duration-300">
