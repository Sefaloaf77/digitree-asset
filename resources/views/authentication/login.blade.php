...
@section('content')
    <div
        class="bg-white text-dark bg-[url('../images/autho-light-bg.png')]'../images/autho-dark-bg.png')] bg-fixed bg-cover bg-center min-h-screen">
        <!-- Start Content -->
        <div class="relative">
            <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <p>Don't have an account? <a href="{{ route('signin') }}"
                            class="font-semibold underline underline-offset-4 text-success">Sign Up for Free</a></p>
                </div>
            </div>
            <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
                <div
                    class="sm:p-[60px] p-9 border-2 border-gray/10 bg-white/10 backdrop-blur-3xl max-w-[620px] mx-auto rounded-lg w-full">
