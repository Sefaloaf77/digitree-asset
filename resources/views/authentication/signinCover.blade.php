    ...
    <div class="relative">
        <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between absolute w-full flex-wrap gap-5">
            ...
            <div class="flex items-center gap-4">
                ...
                <p class="lg:bg-white/10 bg-primary text-white p-3.5 rounded-lg">Already have an account? <a href="{{ route('loginCover') }}" class="font-semibold underline underline-offset-4">Login</a></p>
            </div>
        </div>
        <div class="min-h-screen place-content-center flex">
            <div class="flex w-full">
                <div class="p-10 flex flex-col w-full lg:w-1/2 pt-44 lg:py-[132px] justify-center">
                    <div class="max-w-[500px] mx-auto w-full">
                        ...
                        <form class="mt-[60px] space-y-5">
                            <div class="relative">
                                ...
                                <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <ellipse opacity="0.3" cx="12" cy="17" rx="7" ry="4" fill="currentColor" />
                                    </svg>
                                </span>
                            </div>
                            <div class="relative">
                            ...
                            <div class="!mt-[50px]">
                                <button type="button" class="btn bg-primary hover:bg-primary/90 duration-300 py-6 uppercase tracking-widest font-bold text-sm rounded-[10px] text-white w-full">
                                    Create account
                                </button>
                            </div>
                        </form>
                ...
                <div class="hidden lg:flex w-1/2 bg-primary flex-col py-[132px] justify-center bg-[url('../images/bg-cover.png')] bg-cover bg-no-repeat bg-center">
                    <div>
                        <img src="{{ asset('assets/images/signin-cover.png') }}" class="mx-auto" alt="">
