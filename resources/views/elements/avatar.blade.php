    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                <div class="relative h-24 w-24">
                    <img src="{{ asset('assets/images/avatar-9.png') }}" class="h-24 w-24 flex-none rounded-full object-cover" alt="avatar">
                    <span class="absolute bottom-0 h-7 w-7 rounded-full bg-danger ring-2 ring-white right-0"></span>
                </div>
                <div class="relative h-20 w-20">
                    <img src="{{ asset('assets/images/avatar-10.png') }}" class="h-20 w-20 flex-none rounded-full object-cover" alt="avatar">
                    <span class="absolute bottom-0 h-6 w-6 rounded-full bg-warning ring-2 ring-white right-0"></span>
                </div>
                <div class="relative h-16 w-16">
                    <img src="{{ asset('assets/images/avatar-11.png') }}" class="h-16 w-16 flex-none rounded-full object-cover" alt="avatar">
                    <span class="absolute bottom-0 h-5 w-5 rounded-full bg-success ring-2 ring-white right-0"></span>
                </div>
                <div class="relative h-12 w-12">
                    <img src="{{ asset('assets/images/avatar-12.png') }}" class="h-12 w-12 flex-none rounded-full object-cover" alt="avatar">
                    <span class="absolute bottom-0 h-4 w-4 rounded-full bg-gray ring-2 ring-white right-0"></span>
                </div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                <div class="relative h-24 w-24">
                    <img src="{{ asset('assets/images/avatar-19.png') }}" class="h-24 w-24 flex-none rounded-md object-cover" alt="avatar">
                    <span class="absolute -bottom-2 -right-2 h-7 w-7 rounded-full bg-danger ring-2 ring-white"></span>
                </div>
                <div class="relative h-20 w-20">
                    <img src="{{ asset('assets/images/avatar-20.png') }}" class="h-20 w-20 flex-none rounded-md object-cover" alt="avatar">
                    <span class="absolute -bottom-2 -right-2 h-6 w-6 rounded-full bg-warning ring-2 ring-white"></span>
                </div>
                <div class="relative h-16 w-16">
                    <img src="{{ asset('assets/images/avatar-21.png') }}" class="h-16 w-16 flex-none rounded-md object-cover" alt="avatar">
                    <span class="absolute -bottom-2 -right-2 h-5 w-5 rounded-full bg-success ring-2 ring-white"></span>
                </div>
                <div class="relative h-12 w-12">
                    <img src="{{ asset('assets/images/avatar-22.png') }}" class="h-12 w-12 flex-none rounded-md object-cover" alt="avatar">
                    <span class="absolute -bottom-2 -right-2 h-4 w-4 rounded-full bg-gray ring-2 ring-white"></span>
                </div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex items-center justify-start -space-x-4">
                <img src="{{ asset('assets/images/avatar-2.png') }}" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover" alt="avatar">
                <img src="{{ asset('assets/images/avatar-3.png') }}" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover" alt="avatar">
                <img src="{{ asset('assets/images/avatar-9.png') }}" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover" alt="avatar">
                <img src="{{ asset('assets/images/avatar-10.png') }}" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover" alt="avatar">
                <img src="{{ asset('assets/images/avatar-11.png') }}" class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover" alt="avatar">
                <span class="flex justify-center items-center w-10 h-10 text-center rounded-full object-cover bg-white font-bold text-xs ring-2 ring-lightgray/10">+99</span>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <div class="h-12 w-12 rounded-full flex items-center justify-center font-semibold bg-dark/10 text-base uppercase">DH</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <div class="h-12 w-12 rounded-md flex items-center justify-center font-semibold bg-dark/10 text-base uppercase">DH</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <div class="h-12 w-12 rounded-md flex items-center justify-center font-semibold bg-dark/10 text-base uppercase">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle opacity="0.3" cx="12" cy="6" r="4" fill="currentColor"></circle>
                        <ellipse cx="12" cy="17" rx="7" ry="4" fill="currentColor"></ellipse>
                    </svg>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                ...
                <img src="{{ asset('assets/images/avatar-14.png') }}" class="h-16 w-16 flex-none border border-dark p-1 rounded-full object-cover" alt="avatar">
                <img src="{{ asset('assets/images/avatar-15.png') }}" class="h-16 w-16 flex-none border border-lightgray/10 p-1 rounded-full object-cover" alt="avatar">
            </div>
        </div>
    </div>
</div>
