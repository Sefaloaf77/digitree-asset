    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div class="rounded p-3 bg-dark/10">A simple black alert—check it out!</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div class="rounded p-3 bg-dark/10 border border-dark/60">A simple black alert—check it out!</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div class="rounded p-3 bg-dark text-white border border-dark/60 flex items-center gap-2" x-show="showElement" x-data="{ showElement: true }">A simple black alert—check it out!
                    <button type="button" x-on:click="showElement = false" class="ml-auto hover:opacity-80 rotate-0 hover:rotate-180 transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                            <path d="M12.0007 10.5865L16.9504 5.63672L18.3646 7.05093L13.4149 12.0007L18.3646 16.9504L16.9504 18.3646L12.0007 13.4149L7.05093 18.3646L5.63672 16.9504L10.5865 12.0007L5.63672 7.05093L7.05093 5.63672L12.0007 10.5865Z" fill="currentColor"></path>
                        </svg>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div class="rounded p-3 bg-dark/10 border border-dark/60 flex items-center gap-2" x-show="showElement" x-data="{ showElement: true }">A simple black alert—check it out!
                    <button type="button" x-on:click="showElement = false" class="ml-auto hover:opacity-80 rotate-0 hover:rotate-180 transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                            <path d="M12.0007 10.5865L16.9504 5.63672L18.3646 7.05093L13.4149 12.0007L18.3646 16.9504L16.9504 18.3646L12.0007 13.4149L7.05093 18.3646L5.63672 16.9504L10.5865 12.0007L5.63672 7.05093L7.05093 5.63672L12.0007 10.5865Z" fill="currentColor"></path>
                        </svg>
