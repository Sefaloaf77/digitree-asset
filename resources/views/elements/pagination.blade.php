...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg md:col-span-2">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg md:col-span-2">
            ...
            <div class="flex flex-wrap items-center justify-center sm:justify-between gap-3 overflow-scroll">
                <div class="text-left text-lightgray">Showing <span class="font-semibold text-dark">1</span> to <span class="font-semibold text-dark">10</span> of <span class="font-semibold text-dark">154</span> results.</div>
