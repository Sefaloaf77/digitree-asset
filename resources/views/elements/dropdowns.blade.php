    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                <div x-data="{ dropdown: false}" class="dropdown">
                    <button class="btn bg-dark border border-dark rounded-md text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85] flex items-center justify-center gap-1.5" @click="dropdown = !dropdown" @keydown.escape="dropdown = false">Dropdown Menu
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                            <path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="currentColor"></path>
                        </svg>
                    </button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 justify-center">
                ...
                <div x-data="{ dropdown: false}" class="dropdown">
                    <button type="button" class="flex items-center bg-dark border border-dark rounded-md text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85]">
