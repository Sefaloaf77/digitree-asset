    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                ...
                <div class="animate-spin inline-block w-8 h-8 border-[3px] border-l-transparent border-dark rounded-full"></div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-5">
                ...
                <div class="animate-spin inline-block w-5 h-5 border-[3px] border-l-transparent border-dark rounded-full"></div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap items-center gap-6">
                ...
                <div class="relative">
                    <span class="inline-block w-5 h-5">
                        <span class="animate-ping inline-flex h-full w-full rounded-full bg-dark/50"></span>
                    </span>
                </div>
                <div class="relative">
                    <span class="inline-block w-5 h-5">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex items-center flex-wrap justify-center gap-5">
                ...
                <div class="animate-[spin_3s_linear_infinite] border-8 border-r-gray/10 border-l-purple border-t-dark border-b-success rounded-full w-14 h-14 inline-block align-middle">
                </div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
