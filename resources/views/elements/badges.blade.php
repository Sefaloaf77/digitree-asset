    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                ...
                <div class="inline-flex items-center rounded text-xs justify-center px-1.5 py-0.5 bg-dark text-white">Black</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                ...
                <div class="inline-flex items-center rounded-full text-xs justify-center px-1.5 py-0.5 bg-dark text-white">Black</div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                ...
                <div class="inline-flex items-center rounded text-xs justify-center px-1.5 py-0.5 border border-dark">Black</div>
                <div class="inline-flex items-center rounded text-xs justify-center px-1.5 py-0.5 border border-gray/20 text-dark">Light</div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                ...
                <div class="inline-flex items-center rounded text-xs justify-center px-1.5 py-0.5 bg-dark/10">Black</div>
                <div class="inline-flex items-center rounded text-xs justify-center px-1.5 py-0.5 bg-gray/10">Light</div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                ...
                <div class="inline-flex items-center text-xs justify-center px-1.5 py-0.5 text-black">
                    <span class="h-1.5 w-1.5 rounded-full bg-current me-1.5"></span>
                    <span>Black</span>
                </div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5 items-center">
                <button type="button" class="btn bg-dark border border-dark rounded-md text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85] relative">Messages
                ...
                <button type="button" class="btn bg-dark border border-dark rounded-md text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85]">Notifications
