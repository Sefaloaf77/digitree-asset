    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-col items-center justify-center gap-5">
                ...
                <div class="w-full h-4 bg-gray/20 rounded-full">
                    <div class="bg-dark h-4 rounded-full w-8/12"></div>
                </div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="w-full h-3.5 bg-gray/20 rounded-full">
                <div class="bg-dark h-3.5 rounded-full w-6/12 text-center flex justify-center items-center">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="w-full flex h-3.5 bg-gray/20 rounded">
                ...
                <div class="bg-dark h-3.5 rounded-r w-3/12"></div>
            </div>
        </div>
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
