    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn bg-dark border border-dark rounded-md text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85]">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn bg-dark border border-dark rounded-full text-white transition-all duration-300 hover:bg-dark/[0.85] hover:border-dark/[0.85]">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn border border-dark rounded-md text-dark hover:text-white transition-all duration-300 hover:bg-dark hover:border-dark">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn border border-transparent rounded-md  transition-all duration-300 hover:bg-dark/10">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn border border-transparent rounded-md  transition-all duration-300 hover:text-white hover:bg-dark bg-dark/10">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="btn bg-dark border border-dark rounded-md text-white transition-all duration-300 opacity-60 cursor-not-allowed">black</button>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="flex flex-wrap gap-5">
                ...
                <button type="button" class="bg-gray/10 w-10 h-10 flex items-center justify-center hover:bg-dark hover:text-white border border-transparent rounded-md transition-all duration-300">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
