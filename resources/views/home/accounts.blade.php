...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1">
        <div>
            <ul class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                ...
                <li>
                    <a href="{{ route('accounts') }}" class="text-dark duration-300">Accounts</a>
                </li>
                <li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg lg:col-span-3">
            <div class="flex sm:items-center gap-2.5">
                <img src="{{ asset('assets/images/account-profile.png') }}" class="h-[58px] rounded-full" alt="">
                <div class="space-y-2">
            ...
            <div class="mt-[30px] space-y-[30px]">
                ...
                <div class="bg-white border-2 border-lightgray/10 px-5 py-3.5 rounded-lg">
                    <div class="flex items-center gap-1.5">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg lg:col-span-2">
    ...
    <div>
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:col-span-3 gap-5">
                ...
                <div class="lg:col-span-3 bg-white border-2 border-lightgray/10 p-5 rounded-lg">
