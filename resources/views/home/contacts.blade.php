    ...
    <div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
        <div class="grid grid-cols-1 gap-4" x-data="contact">
            <div class="flex gap-5 relative overflow-hidden">
                {{-- <div class="bg-white inset-y-0 border-2 border-lightgray/10 rounded-l-lg xl:rounded-lg py-5 absolute w-80 z-20 flex-none -left-80 xl:static overflow-hidden"
                ...
                <div class="h-[calc(100vh-320px)] overflow-auto space-y-[30px] px-5 mt-[30px]">
                    ...
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-14.png') }}" class="h-[42px] rounded-full" alt="">
                        <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-15.png') }}" class="h-[42px] rounded-full" alt="">
                        <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-16.png') }}" class="h-[42px] rounded-full" alt="">
                        <div class="flex-1">
            ...
            {{-- <div class="bg-dark/90 backdrop-blur-sm lg:hidden z-[5] w-full h-full absolute rounded-md hidden"
                :class="isShowContactList &amp;&amp; '!block xl:!hidden'"
                @click="isShowContactList = !isShowContactList"></div> --}}
            <!-- <div class="bg-white border-2 border-lightgray/10 rounded-lg flex-grow min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]"> -->
            <div class="flex-grow flex flex-col gap-7 h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)] overflow-y-auto"
                ...
                <div class="bg-white border-2 border-lightgray/10 rounded-lg p-5 flex-1 sm:flex-none relative">
                    <div class="flex items-center gap-5 justify-between flex-wrap">
                        <div class="flex items-center gap-2.5">
                            ...
                            <img src="{{ asset('assets/images/avatar-18.png') }}" class="h-20 rounded-full"
                                alt="">
                            <div>
                        ...
                        <div class="flex items-center gap-5">
                            <div class="space-y-2.5 text-center text-lightgray">
                                <a href="javascript:;"
                                    class="dark:border-gray/20 border-2 border-lightgray/10 w-9 h-9 flex items-center justify-center rounded-full">
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13 7.50005L7 7.50005M7 7.50005L1 7.50005M7 7.50005L7 1.5M7 7.50005L7 13.5"
                    ...
                    <div class="h-[2px] bg-gray/10 block my-[30px]"></div>
                    <div class="flex items-center gap-3 flex-wrap">
                        <button @click="activeTab = 'activity'"
                            :class="activeTab === 'activity' ? 'text-white border-primary bg-primary' :
                                'hover:text-white hover:bg-primary hover:border-primary text-gray'"
                            class="text-xs/none duration-300 font-bold uppercase border-2 border-lightgray/10 rounded-full py-3.5 px-5">
                            Activity
                        </button>
                        <button @click="activeTab = 'notes'"
                            :class="activeTab === 'notes' ? 'text-white border-primary bg-primary' :
                                'hover:text-white hover:bg-primary hover:border-primary text-gray'"
                            class="text-xs/none duration-300 font-bold uppercase border-2 border-lightgray/10 rounded-full py-3.5 px-5">
                            Notes
                        </button>
                        <button @click="activeTab = 'emails'"
                            :class="activeTab === 'emails' ? 'text-white border-primary bg-primary' :
                                'hover:text-white hover:bg-primary hover:border-primary text-gray'"
                            class="text-xs/none duration-300 font-bold uppercase border-2 border-lightgray/10 rounded-full py-3.5 px-5">
                            Emails
                        </button>
                        <button @click="activeTab = 'meetings'"
                            :class="activeTab === 'meetings' ? 'text-white border-primary bg-primary' :
                                'hover:text-white hover:bg-primary hover:border-primary text-gray'"
                            class="text-xs/none duration-300 font-bold uppercase border-2 border-lightgray/10 rounded-full py-3.5 px-5">
                            Meetings
                        </button>
                ...
                <div x-show="activeTab === 'activity'" class="p-5 border-2 border-lightgray/10 rounded-lg flex-grow">
                    <div class="flex items-center gap-5 flex-wrap justify-between">
                        ...
                        <div class="flex items-center gap-2.5">
                            <div x-data="{ dropdown: false }" class="dropdown">
                                <a href="javaScript:;"
                                    class="font-semibold uppercase border-2 border-lightgray/10 gap-2 py-2 px-3.5 rounded-lg items-center flex justify-center"
                                    @click="dropdown = !dropdown" @keydown.escape="dropdown = false">
                            ...
                            <div x-data="{ dropdown: false }" class="dropdown">
                                <a href="javaScript:;"
                                    class="font-semibold uppercase border-2 border-gray/20 gap-2 py-2 px-3.5 rounded-lg items-center flex justify-center"
                                    @click="dropdown = !dropdown" @keydown.escape="dropdown = false">
                                    <div class="flex items-center gap-1.5">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="mt-5 flex items-center justify-between gap-4 sm:flex-row flex-col">
                                <div class="flex items-center justify-start -space-x-4">
                                    <img src="{{ asset('assets/images/avatar-2.png') }}"
                                        class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover"
                                        alt="avatar">
                                    <img src="{{ asset('assets/images/avatar-3.png') }}"
                                        class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover"
                                        alt="avatar">
                                    <img src="{{ asset('assets/images/avatar-9.png') }}"
                                        class="h-10 w-10 flex-none rounded-full ring-2 ring-lightgray/10 object-cover"
                                        alt="avatar">
                                </div>
                ...
                <div x-show="activeTab === 'notes'" class="flex-grow">
                    <div class="grid grid-cols-1 gap-7">
                        <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                            ...
                            <div class="py-5 border-t-2 border-lightgray/10 p-5">
                                        ...
                                        <div class="flex items-center flex-wrap gap-5">
                                            <button class="text-lightgray hover:text-primary duration-300">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    ...
                                                    <path d="M2.5 12.0833H17.5" stroke="currentColor" stroke-width="1.6"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M2.5 16.25H10.3917" stroke="currentColor" stroke-width="1.6"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </button>
                                            <button class="text-lightgray hover:text-primary duration-300">
                                            ...
                                            <button class="text-lightgray hover:text-primary duration-300">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    ...
                                                    <path d="M2.5 12.0833H17.5" stroke="currentColor" stroke-width="1.6"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M9.60834 16.25H17.5" stroke="currentColor" stroke-width="1.6"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </button>
                                            ...
                                            <button class="text-lightgray hover:text-primary duration-300">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2.5 18.3334H12.5M7.5 1.66675H17.5M7.5 18.3334L12.5 1.66675"
                                                        stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                            </button>
                                            <button class="text-lightgray hover:text-primary duration-300">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    ...
                                                    <path d="M5.83331 17.5H14.1666" stroke="currentColor"
                                                        stroke-width="1.6" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M3.33331 10H16.6666" stroke="currentColor" stroke-width="1.6"
                                                        stroke-linecap="round" />
                                                </svg>
                                            </button>
                                            <button class="text-lightgray hover:text-primary duration-300">
                        ...
                        <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                            ...
                            <div class="p-5 border-t-2 border-lightgray/10">
                                <div class="space-y-5" x-data="{ current: 1 }">
                                    <div class="dark:border-gray/20 border-2 border-lightgray/10 rounded-lg">
                                        <button type="button"
                                            class="p-4 w-full flex-wrap flex sm:flex-row flex-col sm:items-center gap-4 text-gray"
                                            :class="{ '!text-dark': current === 1 }"
                                        ...
                                        <div x-show="current === 1" x-collapse>
                                            <div class="space-y-3 p-5 border-t-2 border-lightgray/10">
                ...
                <div x-show="activeTab === 'emails'" class="p-5 border-2 border-lightgray/10 rounded-lg flex-grow">
                    <div class="flex items-center gap-5 flex-wrap justify-between">
                    ...
                    <div class="mt-7 grid grid-cols-1 gap-7">
                        <div class="p-5 border-2 border-lightgray/10 rounded-lg">
                            <div class="flex sm:flex-row flex-col sm:items-center gap-5">
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/images/avatar-1.png') }}"
                                        class="h-[42px] w-[42px] rounded-full" alt="">
                                    <div class="space-y-1">
                                        <p class="font-semibold text-sm">Charles Macomber</p>
                                        <p class="text-lightgray text-xs font-semibold">How are you
                                            today?</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-5 sm:ml-auto text-gray">
                            ...
                            <div class="mt-7 flex flex-wrap items-center gap-2.5">
                                <button type="button"
                                    ...
                                    <svg class="text-purple" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button type="button"
                                    class="flex items-center gap-2.5 border-2 border-gray/10 py-3 px-3.5 rounded-full">
                                    <svg class="text-primary" width="18" height="15" viewBox="0 0 18 15"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5"
                ...
                <div x-show="activeTab === 'meetings'" class="p-5 border-2 border-lightgray/10 rounded-lg flex-grow">
                    <div class="flex items-center gap-5 flex-wrap justify-between">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center gap-2.5">
                                                <div class="flex items-center justify-start -space-x-1">
                                                    <img src="{{ asset('assets/images/avatar-2.png') }}"
                                                        class="h-5 w-5 flex-none rounded-full ring-2 ring-white object-cover"
                                                        alt="avatar">
                                                    <img src="{{ asset('assets/images/avatar-3.png') }}"
                                                        class="h-5 w-5 flex-none rounded-full ring-2 ring-white object-cover"
                                                        alt="avatar">
