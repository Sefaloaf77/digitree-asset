        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <div>
                        <span
                            class="flex items-center text-gray bg-gray/10 rounded-full py-1 px-2 gap-1 text-xs font-semibold">3.47%
                            <svg width="10" height="10" class="inline-block" viewBox="0 0 10 10" fill="none"
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <div>
                        <span
                            class="flex items-center text-gray bg-gray/10 rounded-full py-1 px-2 gap-1 text-xs font-semibold">9.69%
                            <svg width="10" height="10" class="inline-block" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5.73684 9.21053C5.73684 9.64654 5.38338 10 4.94737 10C4.51135 10 4.15789 9.64654 4.15789 9.21053L4.15789 2.69543L2.34772 4.50561C2.03941 4.81392 1.53954 4.81392 1.23123 4.50561C0.922923 4.1973 0.922923 3.69743 1.23123 3.38913L4.38913 0.231232C4.53718 0.0831764 4.73799 -1.83028e-08 4.94737 0C5.15675 1.83066e-08 5.35756 0.0831765 5.50561 0.231232L8.66351 3.38913C8.97181 3.69743 8.97181 4.1973 8.66351 4.50561C8.3552 4.81392 7.85533 4.81392 7.54702 4.50561L5.73684 2.69543V9.21053Z"
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <div>
                        <span
                            class="flex items-center text-gray bg-gray/10 rounded-full py-1 px-2 gap-1 text-xs font-semibold">2.58%
                            <svg width="10" height="10" class="inline-block rotate-180" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5.73684 9.21053C5.73684 9.64654 5.38338 10 4.94737 10C4.51135 10 4.15789 9.64654 4.15789 9.21053L4.15789 2.69543L2.34772 4.50561C2.03941 4.81392 1.53954 4.81392 1.23123 4.50561C0.922923 4.1973 0.922923 3.69743 1.23123 3.38913L4.38913 0.231232C4.53718 0.0831764 4.73799 -1.83028e-08 4.94737 0C5.15675 1.83066e-08 5.35756 0.0831765 5.50561 0.231232L8.66351 3.38913C8.97181 3.69743 8.97181 4.1973 8.66351 4.50561C8.3552 4.81392 7.85533 4.81392 7.54702 4.50561L5.73684 2.69543V9.21053Z"
                                    fill="currentColor" />
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <div>
                        <span
                            class="flex items-center text-gray bg-gray/10 rounded-full py-1 px-2 gap-1 text-xs font-semibold">4.23%
                            <svg width="10" height="10" class="inline-block" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5.73684 9.21053C5.73684 9.64654 5.38338 10 4.94737 10C4.51135 10 4.15789 9.64654 4.15789 9.21053L4.15789 2.69543L2.34772 4.50561C2.03941 4.81392 1.53954 4.81392 1.23123 4.50561C0.922923 4.1973 0.922923 3.69743 1.23123 3.38913L4.38913 0.231232C4.53718 0.0831764 4.73799 -1.83028e-08 4.94737 0C5.15675 1.83066e-08 5.35756 0.0831765 5.50561 0.231232L8.66351 3.38913C8.97181 3.69743 8.97181 4.1973 8.66351 4.50561C8.3552 4.81392 7.85533 4.81392 7.54702 4.50561L5.73684 2.69543V9.21053Z"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/images/product/1.png') }}" class="w-[50px] rounded-full"
                                        alt="">
                            ...
                            <td>2</td>
                            <td><span class="bg-success text-white font-bold text-xs py-2 px-3 rounded-full">Paid</span>
                            </td>
                            <td>$215</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/images/product/2.png') }}" class="w-[50px] rounded-full"
                                        alt="">
                                    <div class="flex-1 max-w-[200px] truncate">
                            ...
                            <td>3</td>
                            <td><span
                                    class="bg-orange text-white font-bold text-xs py-2 px-3 rounded-full">Unpaid</span>
                            </td>
                            <td>$542</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/images/product/3.png') }}" class="w-[50px] rounded-full"
                                        alt="">
                                    <div class="flex-1 max-w-[200px] truncate">
                            ...
                            <td>5</td>
                            <td><span class="bg-primary text-white font-bold text-xs py-2 px-3 rounded-full">Done</span>
                            </td>
                            <td>$980</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/images/product/4.png') }}" class="w-[50px] rounded-full"
                                        alt="">
                                    <div class="flex-1 max-w-[200px] truncate">
