...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1">
        <div>
            <ul class="font-semibold text-lightgray flex items-center gap-4 sm:gap-[30px] gap-y-4 whitespace-nowrap overflow-auto">
                <li>
                    <a href="{{ route('ecommerce') }}" class="hover:text-dark duration-300">Overview</a>
                </li>
                <li>
                    <a href="{{ route('orderList') }}" class="hover:text-dark duration-300">Order List</a>
                </li>
                <li>
                    <a href="{{ route('accounts') }}" class="hover:text-dark duration-300">Accounts</a>
                </li>
                <li>
                    <a href="{{ route('payments') }}" class="text-dark duration-300">Payments</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="grid grid-cols-1 xl:grid-cols-3 xl:gap-5 gap-y-5">
        <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 xl:gap-5 lg:col-span-2 space-y-5 xl:space-y-0">
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg md:col-span-3 xl:col-span-2">
                <div class="flex items-center gap-5 mb-[30px] justify-between flex-wrap">
                    ...
                    <ul class="flex gap-5 items-center text-sm">
                        ...
                        <li>
                            <a href="javascript:;" class="text-gray hover:text-dark">Day</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="text-gray hover:text-dark">Week</a>
                        </li>
                    </ul>
                </div>
                <div class="space-y-[30px]">
                    <div class="flex items-stretch gap-8 sm:gap-[30px] xl:justify-between flex-wrap bg-white border-2 border-lightgray/10 p-5 rounded-lg">
                        <div>
                    ...
                    <div>
                        <ul class="flex items-center flex-wrap gap-5">
                            <li>
                                <a href="#" class="btn bg-dark text-white">Clients Charter</a>
                            </li>
                            <li>
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg space-y-5 md:col-span-3 xl:col-auto">
                <div>
                    ...
                    <ul class="mt-5 space-y-[22px]">
                        ...
                        <li>
                            <a href="#" class="flex items-center gap-2.5">
                                ...
                                <div>
                                    <p class="text-sm text-dark">Password Changed</p>
                ...
                <div>
                    <div class="flex items-center gap-2">
                        <h4 class="font-semibold text-dark">Activities</h4>
                        <div x-data="{ dropdown: false}" class="dropdown ml-auto">
                            <a href="javaScript:;" class="text-lightgray h-3 flex items-center justify-center" @click="dropdown = !dropdown" @keydown.escape="dropdown = false">
                                <svg width="18" height="4" viewBox="0 0 18 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2" cy="2" r="2" fill="currentColor" />
                    ...
                    <ul class="mt-5 space-y-[22px]">
                        <li>
                            <a href="#" class="flex items-center gap-2.5">
                                <div class="w-9 h-9 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                                    <img src="{{ asset('assets/images/avatar-1.png') }}" class="rounded-full" alt="">
                                </div>
                                <div>
                                    <p class="text-sm text-dark">Edited the details of Project</p>
                                    <p class="text-xs text-gray mt-0.5">Just now</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center gap-2.5">
                                <div class="w-9 h-9 bg-purple/10 rounded-full flex items-center justify-center shrink-0">
                                    <img src="{{ asset('assets/images/avatar-2.png') }}" class="rounded-full" alt="">
                                </div>
                                <div>
                                    <p class="text-sm text-dark">Released a new version</p>
                                    <p class="text-xs text-gray mt-0.5">59 minutes ago</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center gap-2.5">
                                ...
                                <div>
                                    <p class="text-sm text-dark">Submitted a bug</p>
                                    <p class="text-xs text-gray mt-0.5">5 hours ago</p>
                                </div>
                            </a>
                        </li>
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg md:col-span-3 lg:col-span-5 xl:col-span-3">
                <div class="flex items-center gap-5 mb-[30px] justify-between flex-wrap">
                    ...
                    <ul class="flex gap-5 items-center text-sm">
                        ...
                        <li>
                            <a href="javascript:;" class="text-gray hover:text-dark">2022</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="text-gray hover:text-dark">2021</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg">
            <div class="flex items-center gap-2 mb-[30px]">
                <h4 class="font-semibold text-dark">Wallet</h4>
                <div x-data="{ dropdown: false}" class="dropdown ml-auto">
                    <a href="javaScript:;" class="text-lightgray h-3 flex items-center justify-center" @click="dropdown = !dropdown" @keydown.escape="dropdown = false">
                        <svg width="18" height="4" viewBox="0 0 18 4" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="px-3.5 relative -mt-16">
                    <div class="bg-gradient-to-t from-dark/30 to-white/10 border-2 border-transparent backdrop-blur-md rounded-[10px] px-[30px] py-5">
                        <div class="flex items-stretch gap-2.5 text-lg/none">
                            <p class="font-bold text-white">Maglo.</p>
                            <span class="bg-success shrink-0 w-[2px]"></span>
                            <p class="text-gray">Universal Bank</p>
                        ...
                        <div class="mt-[30px]">
                            <p class="font-extrabold text-lg text-dark tracking-widest">85952548****</p>
            ...
            <div class="flex items-center justify-between gap-2 my-[30px]">
                <h4 class="font-semibold text-dark">Scheduled Transfers</h4>
                <div>
            ...
            <div class="space-y-5">
                <div class="flex items-center gap-2.5 justify-between">
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-4.png') }}" class="h-10 rounded-full" alt="">
                ...
                <div class="flex items-center gap-2.5 justify-between">
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-5.png') }}" class="h-10 rounded-full" alt="">
                        <div class="space-y-1.5">
                ...
                <div class="flex items-center gap-2.5 justify-between">
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-6.png') }}" class="h-10 rounded-full" alt="">
                        <div class="space-y-1.5">
                ...
                <div class="flex items-center gap-2.5 justify-between">
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-7.png') }}" class="h-10 rounded-full" alt="">
                        <div class="space-y-1.5">
                ...
                <div class="flex items-center gap-2.5 justify-between">
                    <div class="flex items-center gap-3.5">
                        <img src="{{ asset('assets/images/avatar-8.png') }}" class="h-10 rounded-full" alt="">
                        <div class="space-y-1.5">
