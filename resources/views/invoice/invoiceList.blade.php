    ...
    <div class="grid grid-cols-1 gap-5">
        ...
        <div class="flex items-center gap-5 justify-between flex-wrap">
            <ul class="flex items-center gap-2.5 flex-wrap">
                ...
                <li>
                    <a href="javascript:;" class="rounded-full text-sm/none font-semibold border-2 border-gray/10 hover:border-primary hover:text-black duration-300 text-gray px-5 py-3.5 inline-block">Open invoices</a>
                </li>
                <li>
                    <a href="javascript:;" class="rounded-full text-sm/none font-semibold border-2 border-gray/10 hover:border-primary hover:text-black duration-300 text-gray px-5 py-3.5 inline-block">Post invoices</a>
                </li>
            </ul>
            <div class="flex items-center gap-5">
                <form class="w-full">
                    <div class="relative">
                        <input type="text" id="search" class="form-input ps-10 h-[42px] border-2 border-gray/10 bg-gray/[8%] rounded-full text-sm text-dark placeholder:text-lightgray/80 focus:ring-0 focus:border-primary/80 focus:outline-0" placeholder="Search..." required="">
        ...
        <div>
            <ul class="flex items-center gap-1 justify-end">
                <li>
                    <a href="javascript:;" class="text-primary flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md">
                ...
                <li>
                    <a href="javascript:;" class="flex items-center justify-center bg-dark/10 w-7 h-7 rounded-md duration-300">1</a>
                </li>
                <li>
                    <a href="javascript:;" class="flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md duration-300">2</a>
                </li>
                <li>
                    <a href="javascript:;" class="flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md duration-300">3</a>
                </li>
                <li>
                    <a href="javascript:;" class="flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md duration-300">4</a>
                </li>
                <li>
                    <a href="javascript:;" class="flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md duration-300">5</a>
                </li>
                <li>
                    <a href="javascript:;" class="text-primary flex items-center justify-center hover:bg-dark/10 w-7 h-7 rounded-md duration-300">
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
