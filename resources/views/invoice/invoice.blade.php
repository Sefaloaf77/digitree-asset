...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div class="lg:col-span-2">
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg mt-[30px]">
                ...
                <div class="mt-[50px]">
                    ...
                    <div class="overflow-auto mt-5">
                        <table class="min-w-[640px] w-full border-b-2 border-gray/10">
                            <thead class="border-t-2 border-gray/10">
                                <tr class="text-left">
                                    <th>Number</th>
                                    <th>Description</th>
                                    <th>Price</th>
            ...
            <div class="bg-white border-2 border-lightgray/10 p-5 rounded-lg mt-[30px]">
                <div class="space-y-3.5">
                    <div class="relative budget-input">
                        <label class="flex cursor-pointer rounded-lg justify-between bg-white border-2 border-lightgray/10 items-start gap-4 p-5">
                    ...
                    <div class="relative budget-input">
                        <label class="flex cursor-pointer rounded-lg justify-between bg-white border-2 border-lightgray/10 items-center gap-4 p-5">
                            <div class="relative z-10 text-sm font-semibold w-full">
                                <div class="flex items-center gap-4 flex-1">
                                    ...
                                    <div class="w-[2px] bg-gray/20 shrink-0 h-7"></div>
                                    <div>
