...
<div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
    <div class="text-center">
        <p class="text-5xl/snug font-extrabold">Site is Under Maintenance</p>
        <p class="sm:text-2xl text-xl text-gray mt-[30px]">Need support?
            <span class="text-primary block mt-2 font-semibold">website@domain.com</span>
        </p>
        <img src="{{ asset('assets/images/maintenance-light.png') }}" class="lg:mt-32 sm:mt-16 mt-14" alt="">
        <img src="{{ asset('assets/images/maintenance-dark.png') }}" class="lg:mt-32 sm:mt-16 mt-14 hidden" alt="">
    </div>
</div>
