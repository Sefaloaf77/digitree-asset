...
<div class="min-h-[calc(100vh-216px)] p-7 flex justify-center items-center">
    <div class="text-center">
        ...
        <img src="{{ asset('assets/images/503-light.png') }}" class="lg:mt-32 sm:mt-16 mt-14" alt="">
        <img src="{{ asset('assets/images/503-dark.png') }}" class="lg:mt-32 sm:mt-16 mt-14 hidden" alt="">
    </div>
</div>
