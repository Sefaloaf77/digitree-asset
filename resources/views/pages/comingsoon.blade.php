    ...
    <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
        <div class="text-center">
            ...
            <div class="relative max-w-[430px] mx-auto mt-14">
                <input type="email" id="email1" class="form-input h-[66px] bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Enter your email to subscribe for updates.">
            ...
            <img src="{{ asset('assets/images/soon-light.png') }}" class="lg:mt-32 sm:mt-16 mt-14" alt="">
            <img src="{{ asset('assets/images/soon-dark.png') }}" class="lg:mt-32 sm:mt-16 mt-14 hidden" alt="">
        </div>
    </div>
